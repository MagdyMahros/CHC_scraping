...
course_links_file_path = course_links_file_path.__str__() + '/CHC_postgrad_links.txt'
course_links_file = open(course_links_file_path, 'r')

# the csv file we'll be saving the courses to
csv_file_path = Path(os.getcwd().replace('\\', '/'))
csv_file = csv_file_path.__str__() + '/CHC_postgrad.csv'
...
course_data = {'Level_Code': '', 'University': 'Christian Heritage College', 'City': '', 'Country': 'Australia',
               ...
               'Prerequisite_2': '', 'Prerequisite_3': '', 'Prerequisite_1_grade': '7.5', 'Prerequisite_2_grade': '',
...
for each_url in course_links_file:
    ...
    with open(csv_file, 'r', encoding='utf-8') as infile, open('CHC_postgrad_ordered.csv', 'w', encoding='utf-8',
                                                               newline='') as outfile:
